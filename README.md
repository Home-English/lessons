...
- В английском языке это:
  ...
  время ( usualy, sometime :: обысно, иногда )
```
( Ближе всего к английскому языку, по форме образования предложений, подходит украинский язык )
```
В английском языке существует 2-типа глаголов:
1. ДЕЙСТВИЯ (ДЕЛАТЬ ЧТО НИБУДЬ - такие глаголы применяются для формирования полных предложения) применяются в 2-случаях:
...
- НЕПОЛНЫЕ ПРЕДЛОЖЕНИЯ (это абстрактные предложения в которых может отсутствовать инициатор...)
  ...
  ( они ищут тебя ... THERE ARE find-out for you )
...
```
  ( если-бы я хорошо знал английский язык, я бы имел хорошую работу )
- В отличие от русского, украинского языка, в английском языке всегда на первое место в предложении выносится те слова в которых заложен основной смысл
