...
> А в английском языке структура предложения формируются на основе состояний.
  ...
  - Повествование предложение (хронологические события)
    2. Статус (владение) ........................ Я имею дом ............ [have, has]
                                                ( I have the hous )
    3. Сам процесс (действия) выполнения ........ Я читаю книгу ......... [do, does, use, can, would, into, out to, from, +ing] (read, found)
                                                ( Я читаю (сейчас) книгу - I reading the book )
    4. Уже завершенный процесс (действия) ....... Я прочитал книгу ...... [get, give, made, had, done, +ed]
