 ...
 [1] PRESENT SIMPLE                  + +    [3] PRESENT CONTINUOS           | > am/are/is +ing
    (настоящее:                      + +       (настоящеен время:           | > место нахождения (пребывания)
     ...
     > слова частоты действия        + +++     (прошедшее причастие: произошло в прошлом но имеет отношение к настоящему) | > что имею (чем владею)
                                     ...
                                     +   +
     ----------------------------- --+---+-- ---------------------------------------------------------------------------
      Когда рассказывается об        |||||    Когда рассказывается об исторических фактах которые пренадлежат
      действии, которое одинаково    12345    конкретному временному периоду...
...
| WILL | +BY GOING TO |  у | WILL IT ...... love?  | IT ......................      love | IT ....          love |
