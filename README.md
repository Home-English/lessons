...
| Кто ? `это`    | Чье ? `принадлежит` | Кому / Кого ? `обращаются` |
| -------------- |:-------------------:|:--------------------------:|
| I    `я`       | MY    `мое`         | ME   `мне`                 |
|                |                     |                            |
...
```
                                   ...
                                   --++-----
                                     ...
                                     +++----
                                     + +
 [1] PRESENT SIMPLE                  + +    [3] PRESENT CONTINUOS
    (настоящее:                      + +       (настоящеен время:
     происходит регулярно/постояно)  + +        происходит в данный момент)
                                     + +++--
                                     + +++  [4] PRESENT PERFECT
                                     + +++     (прошедшее причастие: произошло в прошлом но имеет отношение к настоящему)
                                     + +++--
                                     +   +
                                     +   +
                                     +   +  [5] PAST SIMPLE
