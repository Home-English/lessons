...
| WILL             |  у | WILL IT ...... love?  | IT ......................      love | IT ....          love |
...
| 2 | put        `пут`        | put        `пут`        | put        `пут`        | класть / ложить         |
| 2 | shut       `шут`        | shut       `шут`        | shut       `шут`        | преградить / затворять  |
| 2 | cost       `кост`       | cost       `кост`       | cost       `кост`       | стоить                  |
|   |                         |                         |                         |                         |
| 2 | hit        `хэйт`       | hit        `хэйт`       | hit        `хэйт`       | ударять / попадание     |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | get        `гэт`        | got        `гот`        | got        `гот`        | получать                |
| 2 | sit        `сит`        | sat        `сэт`        | sat        `сэт`        | сидеть                  |
|   |                         |                         |                         |                         |
| 2 | meet       `миит`       | met        `мэт`        | met        `мэт`        | встречать               |
| 2 | keep       `киип`       | kept       `кэпт`       | kept       `кэпт`       | держать                 |
| 2 | feel       `фиил`       | felt       `фэлт`       | felt       `фэлт`       | чувствовать             |
| 2 | leave      `лиив`       | left       `лэфт`       | left       `лэфт`       | оставлять               |
| 2 | sleep      `слип`       | slept      `слэпт`      | slept      `слэпт`      | спать                   |
|   |                         |                         |                         |                         |
| 2 | lend       `лэнд`       | lent       `лэнт`       | lent       `лэнт`       | давать взаймы           |
| 2 | send       `сэнд`       | sent       `сэнт`       | sent       `сэнт`       | отправлять              |
| 2 | spend      `спэнд`      | spent      `спэнт`      | spent      `спэнт`      | тратить                 |
| 2 | build      `билд`       | built      `билт`       | built      `билт`       | строить                 |
| 2 | learn      `лерн`       | learnt     `лернт`      | learnt     `лернт`      | учиться                 |
| 2 | lose       `лууз`       | lost       `лост`       | lost       `лост`       | терять                  |
|   |                         |                         |                         |                         |
| 2 | catch      `кэч`        | caught     `каутс`      | caught     `каутс`      | поймать                 |
| 2 | buy        `бай`        | bought     `бутс`       | bought     `бутс`       | купить                  |
| 2 | bring      `брин`       | brought    `боутс`      | brought    `боутс`      | приносить               |
| 2 | think      `синк`       | thought    `соутс`      | thought    `соутс`      | думать                  |
| 2 | teach      `тич`        | taught     `тоутс`      | taught     `тоутс`      | учить                   |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | can        `кэн`        | could      `кууд`       | could      `кууд`       | можно                   |
| 2 | pay        `пэй`        | paid       `пэйд`       | paid       `пэйд`       | платить                 |
| 2 | say        `сэй`        | said       `сэйд`       | said       `сэйд`       | сказать                 |
| 2 | have       `хэв`        | had        `хэд`        | had        `хэд`        | иметь                   |
| 2 | make       `мэйк`       | made       `мэйд`       | made       `мэйд`       | делать                  |
|   |                         |                         |                         |                         |
| 2 | win        `вин`        | won        `вон`        | won        `вон`        | побеждать               |
|   |                         |                         |                         |                         |
| 2 | tell       `тэлл`       | told       `туд`        | told       `туд`        | рассказывать            |
| 2 | sell       `сэлл`       | sold       `соуд`       | sold       `соуд`       | продавать               |
| 2 | stand      `стэн`       | stood      `студ`       | stood      `студ`       | стоять                  |
| 2 | understand `андэстэнд`  | understood `андэстууд`  | understood `андэстууд`  | понимать                |
|   |                         |                         |                         |                         |
| 2 | find       `файнд`      | found      `фоуд`       | found      `фоуд`       | находить                |
| 2 | hear       `хиа`        | heard      `хеод`       | heard      `хеод`       | слышать                 |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | come       `кам`        | came       `кэм`        | come       `кам`        | приходить               |
| 2 | become     `бикам`      | became     `бикэм`      | become     `бикам`      | становиться             |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | drive      `драйв`      | drove      `дров`       | driven     `дривн`      | ездить                  |
| 2 | write      `райт`       | wrote      `рот`        | written    `ритн`       | писать                  |
|   |                         |                         |                         |                         |
| 2 | eat        `ит`         | ate        `эт`         | eaten      `итн`        | кушать                  |
|   |                         |                         |                         |                         |
| 2 | give       `гив`        | gave       `гэв`        | given      `гивн`       | давать                  |
| 2 | wear       `вир`        | wore       `вор`        | worn       `ворн`       | носить                  |
| 2 | speak      `спик`       | spoke      `спок`       | spoken     `спокн`      | говорить                |
| 2 | steal      `стил`       | stole      `стол`       | stolen     `столен`     | воровать                |
|   |                         |                         |                         |                         |
| 2 | wake       `вэйк`       | woke       `вок`        | woken      `вокн`       | просыпаться             |
| 2 | break      `брэк`       | broke      `брок`       | broken     `брокн`      | ломать                  |
| 2 | choose     `чууз`       | chose      `чооз`       | chosen     `чузн`       | выбирать                |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | grow       `гроу`       | grew       `грэу`       | grown      `гроун`      | расти                   |
| 2 | know       `ноу`        | knew       `нэу`        | known      `ноун`       | знать                   |
| 2 | throw      `сроу`       | threw      `срэу`       | thrown     `сроун`      | бросать                 |
|   |                         |                         |                         |                         |
| 2 | fly        `флай`       | flew       `флу`        | flown      `флоун`      | летать                  |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | take       `тэйк`       | took       `тук`        | taken      `тэккэн`     | брать                   |
| 2 | fall       `фоол`       | fell       `фэл`        | fallen     `фолэн`      | падать                  |
| 2 | forget     `фогэт`      | forgot     `фогот`      | forgotten  `фоготн`     | забывать                |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | begin      `бэгин`      | began      `бигэн`      | begun      `биган`      | начинать                |
| 2 | drink      `дринк`      | drank      `дрэнк`      | drunk      `дранк`      | пить                    |
| 2 | ring       `рин`        | rang       `рэн`        | rung       `ран`        | звонить                 |
| 2 | run        `ран`        | ran        `рэн`        | run        `ран`        | бежать                  |
| 2 | sing       `син`        | sang       `сэн`        | sung       `сан`        | петь                    |
| 2 | swim       `свим`       | swam       `свэм`       | swum       `свам`       | плавать                 |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | do         `ду`         | did        `дид`        | done       `дан`        | делать                  |
| 2 | go         `гоу`        | went       `вэнт`       | gone       `гон`        | идти                    |
|   | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - | - - - - - - - - - - - - |
| 2 | be         `би`         | was / were `воз / веер` | been       `бин`        | быть                    |
| 2 | see        `сии`        | saw        `со`         | seen       `син`        | видеть                  |
